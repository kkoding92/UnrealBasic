...
void AMyWeapon::OnCharacterOverlap(UPrimitiveComponent* Overlap, AActor* OtherActor, UPrimitiveComponent* OhterComp, int32 OtherBodyIndex, bool bFromSeep, const FHitResult& SweepResult)
{
